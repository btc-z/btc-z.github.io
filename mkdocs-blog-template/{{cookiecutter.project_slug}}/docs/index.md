# Welcome to {{ cookiecutter.site_name }}
...
- **{% now 'utc', '%Y-%m-%d' %} :sparkles: [Welcome to My Blog](posts/reflections/welcome.md)**

### :books: Reading Notes

- **{% now 'utc', '%Y-%m-%d' %} :book: [Sample Book Review](posts/books/sample-book-review.md)**
